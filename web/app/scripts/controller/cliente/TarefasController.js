(function ($, console, doc) {
    ...
    window.ClienteTarefasModel = kendo.observable({
        ...
        show: function () {
            ...
            ClienteTarefasModel.tarefasViewChanged($("#clienteTarefasView #btnTarefasViewToggleM").data("kendoMobileButtonGroup").current().index());
        },
        ...
        edit: function (e) {
            ...
            var data = kendo.toString(kendo.parseDate(ClienteTarefasModel.tarefaSelecionada.schedules[0].startAt), "dd/MM/yyyy");
        ...
        republicar: function (e) {
            ...
            if (kendo.parseDate(horaFim1, "dd/MM/yyyyTHH:mm") < dataAtual || kendo.parseDate(horaFim2, "dd/MM/yyyyTHH:mm") < dataAtual) {
                navigator.notification.alert("Escolha uma data futura.", null, "Aviso", "OK");
                return;
            }

            horaInicio1 = kendo.parseDate(horaInicio1, "dd/MM/yyyyTHH:mm");
            horaInicio2 = kendo.parseDate(horaInicio2, "dd/MM/yyyyTHH:mm");
            horaFim1 = kendo.parseDate(horaFim1, "dd/MM/yyyyTHH:mm");
            horaFim2 = kendo.parseDate(horaFim2, "dd/MM/yyyyTHH:mm");

            horaInicio1 = kendo.toString(horaInicio1, "yyyy'-'MM'-'dd'T'HH':'mm");
            horaInicio2 = kendo.toString(horaInicio2, "yyyy'-'MM'-'dd'T'HH':'mm");
            horaFim1 = kendo.toString(horaFim1, "yyyy'-'MM'-'dd'T'HH':'mm");
            horaFim2 = kendo.toString(horaFim2, "yyyy'-'MM'-'dd'T'HH':'mm");
