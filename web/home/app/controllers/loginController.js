'use strict';
app.controller('loginController', ['$scope', '$http', 'localStorageService', '$q', '$location', 'authService', 'customerService', 'professionalService', 'partnerService', 'ngAuthSettings', '$window', '$timeout', function ($scope, $http, localStorageService, $q, $location, authService, customerService, professionalService, partnerService, ngAuthSettings, $window, $timeout) {
    ...
    $scope.login = function () {
        $window.location = '/sociallogin/#/login';
    }

    $scope.login = function () {
      
        //logout if already loggedin
    ...
    $scope.authCompletedCB = function (fragment) {
        ...
        $scope.$apply(function () {
            ...
            if (fragment.haslocalaccount == 'False') {
                ...
                //$window.location = '/sociallogin/#/associate';
